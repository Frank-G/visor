...
package de.uniulm.omi.cloudiator.visor.bridge.rest.resources;

import de.uniulm.omi.cloudiator.visor.bridge.monitoring.MonitorContext;
...
public class BaseMonitor implements Monitor {
    ...
    public static class MonitorBuilder {
        ...
        public MonitorBuilder interval(
            final de.uniulm.omi.cloudiator.visor.bridge.monitoring.Interval interval) {
