...
package de.uniulm.omi.cloudiator.visor.bridge.reporting.kairos;
...
public class KairosDb implements ReportingInterface<Metric> {
     ...
     * @throws de.uniulm.omi.cloudiator.visor.bridge.reporting.ReportingException If the kairos server could not be reached.
     */
