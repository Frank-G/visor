...
***
## Description
The RESTful interface can be used to start the usage of sensors at the targeted colosseum-mca-bridge agent. It also allows to reconfigure sensors and to stop them.
## Configuration
...
[  
   {  
      ...
      "sensorClassName":"org.ow2.paasage.camel.srl.colosseum_mca_bridge.monitoring.sensors.CpuUsageSensor",
   ...
   {  
      ...
      "sensorClassName":"org.ow2.paasage.camel.srl.colosseum_mca_bridge.monitoring.sensors.MemoryUsageSensor",
...
sensorClassName | String | The canonical name for the Java class that should be used as sensor. Must implement the Sensor Interface. Must be already present in the class path of colosseum-mca-bridge. Required.
#### Example
```
POST /monitors
```
...
{  
  ...
  "metricName":"memory_usage",
  "sensorClassName":"org.ow2.paasage.camel.srl.colosseum_mca_bridge.sensors.MemoryUsageSensor"
}
```
